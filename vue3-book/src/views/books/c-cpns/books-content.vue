...
<template>
  <div class="content">
    <div class="header">
      <h3>书籍列表</h3>
      <el-button type="primary" @click="handleCreateData()">新增</el-button>
    </div>
    <div class="main">
      <el-table :data="List" stripe border style="width: 100%">
        ...
        <el-table-column label="操作" prop="operator" align="center">
          <template #default="scoped">
            <el-button key="primary" type="primary" text icon="Edit" @click="handleEditClick(scoped.row)">编辑</el-button>
