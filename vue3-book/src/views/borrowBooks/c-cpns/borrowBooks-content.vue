...
<template>
    <div class="content">
        <div class="header">
            <h3>书籍列表</h3>
            <el-button type="primary" @click="handleCreateData()">求书</el-button>
        </div>
        <div class="main">
            <el-table :data="List" stripe border style="width: 100%">
                ...
                <el-table-column label="作者" prop="item.prop" align="center" />
                <el-table-column label="简介" prop="item.prop" align="center" />

                <!-- 日期 -->
                <el-table-column label="出版社" prop="item.prop" align="center">

                </el-table-column>
                <el-table-column label="书籍存量" prop="item.prop" align="center" />
                <!-- 编辑 -->
                <el-table-column label="操作" prop="operator" align="center">
                    <template #default="scoped">
                        <el-button key="primary" type="primary" text icon="Edit"
                            @click="handleEditClick(scoped.row)">借阅</el-button>

                        <el-button key="danger" type="primary" text icon="Delete"
                            @click="handleDeleteClick(scoped.row.id)">归还</el-button>
                    </template>
                </el-table-column>
